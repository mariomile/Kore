...
interface AiPreviewActionsProps {
  ...
  /** Accept with the placement opposite to the staged one (old Kore's Replace/Insert choice). */
 ...
 * alternate placement — old Kore let the user pick Replace vs Insert at
