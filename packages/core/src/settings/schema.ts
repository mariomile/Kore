...
/**
 * One strip tab: an ordinary note, or a workspace surface (Settings, Browser,
 * Tasks, …). The open-tabs list (the strip and the sidebar's Open section),
...
/**
 * Search engine used when the in-app browser's new-tab field is free text
