...
const APP_COMMANDS: AppCommand[] = [
  ...
  },
  {
    ...
    keywords: ['split', 'pane', 'row', 'focus'],
    keybinding: 'Alt-Mod-arrowup',
    run: (context) => context.focusPane('up'),
  },
  {
    id: 'pane.focusDown',
    title: 'Focus pane below',
    keywords: ['split', 'pane', 'row', 'focus'],
    keybinding: 'Alt-Mod-arrowdown',
    run: (context) => context.focusPane('down'),
  },
  {
    id: 'pane.moveTabRight',
    title: 'Move tab to a new pane on the right',
    keywords: ['split', 'pane', 'column', 'move', 'tab'],
    keybinding: 'Alt-Mod-Shift-arrowright',
    run: (context) => context.moveActiveTab('right'),
  },
  {
    id: 'pane.moveTabDown',
    title: 'Move tab to a new pane below',
    keywords: ['split', 'pane', 'row', 'move', 'tab'],
    keybinding: 'Alt-Mod-Shift-arrowdown',
    run: (context) => context.moveActiveTab('down'),
  },
  {
    id: 'settings.open',
    title: 'Open settings',
