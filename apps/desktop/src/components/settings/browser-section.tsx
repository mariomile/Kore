...
/**
 * In-app browser preferences: the search engine for the address bar, and
  ...
  return (
    <SettingsSection id="browser">
      <SettingsField
        ...
        description="Used when you type a query instead of a URL in the browser address bar."
      >
