  ...
  return (
    <div className="flex flex-col gap-2">
      <p className="text-sm text-text-muted">
        When you use AI features, Kore sends data directly to {provider.label} using this key: AI
        ...
        passes through a Kore server, and notes you mark as private are never sent.{' '}
        <button
          type="button"
          className="underline"
          onClick={() => {
