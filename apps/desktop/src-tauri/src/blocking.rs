...
mod tests {
    ...
    ("asset_import", "fs/assets.rs", "DEBT (audit 2.3): moves whole asset files on the main thread"),
    ...
    ("asset_upload_append", "fs/assets.rs", "DEBT (audit 2.3): moves whole asset files on the main thread"),
    ("asset_upload_begin", "fs/assets.rs", "DEBT (audit 2.3): moves whole asset files on the main thread"),
    ("asset_upload_commit", "fs/assets.rs", "DEBT (audit 2.3): moves whole asset files on the main thread"),
    ("asset_upload_commit_path", "fs/assets.rs", "DEBT (audit 2.3): moves whole asset files on the main thread"),
    ...
    ("chat_conversation_delete", "db/mod.rs", "DEBT (audit 2.2): SQLite work that can block on a cross-process lock for up to 5s"),
    ("chat_message_save", "db/mod.rs", "DEBT (audit 2.2): SQLite work that can block on a cross-process lock for up to 5s"),
    ...
    ("index_clear", "db/mod.rs", "DEBT (audit 2.2): SQLite work that can block on a cross-process lock for up to 5s"),
    ("index_meta_set", "db/mod.rs", "DEBT (audit 2.2): SQLite work that can block on a cross-process lock for up to 5s"),
    ("index_move", "db/mod.rs", "DEBT (audit 2.2): SQLite work that can block on a cross-process lock for up to 5s"),
    ("index_open", "db/mod.rs", "DEBT (audit 2.2): SQLite work that can block on a cross-process lock for up to 5s"),
    ("index_touch", "db/mod.rs", "DEBT (audit 2.2): SQLite work that can block on a cross-process lock for up to 5s"),
    ...
    ("note_move_indexed", "db/mod.rs", "DEBT (audit 2.2): SQLite work that can block on a cross-process lock for up to 5s"),
